...
<html>
    ...
    <body onload="document.getElementById('cargos').selectedIndex = ${funcionario.cargo.codigo}">
        ...
        <br/>
        <form method="POST" action="${pageContext.request.contextPath}/controller?command=funcionario.confirmar-alteracao">
            <label for="codigo">Código: </label>
            <input type="text" name="codigo" size="6" readonly="true" value="${funcionario.codigo}"/>
            <br/>
            <label for="nome">Nome: </label>
            <input type="text" name="nome" size="60" value="${funcionario.nome}"/>
            <br/>
