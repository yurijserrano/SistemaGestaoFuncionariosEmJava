...
<html>
    <head>
        ...
        <title>Funcionário:Remover</title>
    </head>
    <body>
        <a href="${pageContext.request.contextPath}">principal</a>
        <h1>Funcionário: Remover</h1>
        <br/>
        <form method="POST" action="${pageContext.request.contextPath}/controller?command=funcionario.removerPorId">
